...
riot.tag('calls-table',
  ...
  function constructor (options) {
    ...
    this.showModal = function () {
      ...
      // DONE:30 FIX CRITICAL after each show, a new modal is created
      // TODO:40 change semantic ui component table to order the table properly(via RiotJS)
      // DONE:20 FIX MEDIUM on route change(map/table), riot should update and not mount.
      window.$('#modal')
